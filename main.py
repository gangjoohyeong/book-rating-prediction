...
def define_argparser():
    ...
    parser.add_argument('--data_shuffle', type=int, default=1, help='데이터 셔플 여부를 조정할 수 있습니다.')
    ...
    parser.add_argument('--use_best_model', type=int, default=1, help='검증 성능이 가장 좋은 모델 사용여부를 설정할 수 있습니다.')
    ...
    ############### FM, FFM, DeepFFM
    parser.add_argument('--preprocessed', type=int, default=1, help='FM, FFM, DeepFFM에서 전처리된 데이터를 사용하는지 여부를 조정합니다. default=True')
    ...
    ############### DeepCoNN
    parser.add_argument('--vector_create', type=int, default=1, help='DEEP_CONN에서 text vector 생성 여부를 조정할 수 있으며 최초 학습에만 True로 설정하여야합니다.')
